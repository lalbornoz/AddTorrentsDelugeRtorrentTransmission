...
call roarie_commands#AddMapping("&Project", "git_commit", "Show &git commits...", "Show Git commits with Fzf...", "<silent>", '<M-F6>', ':<C-U>FzfCommits<CR>', "<fnalias>", "")
call roarie_commands#AddMapping("&Project", "git_commit_buf", "Show &git commits in buffer...", "Show Git commits in current buffer with Fzf...", "<silent>", '<M-S-F6>', ':<C-U>FzfBCommits<CR>', "<fnalias>", "")
...
call roarie_commands#AddMapping("&Project", "git_submenu", "&Git submenu...", "Git submenu...", "<silent>", '<C-S-F6>', ':<C-U>call roarie_commands#OpenSubMenu("git_submenu")<CR>', "<fnalias>", "")
