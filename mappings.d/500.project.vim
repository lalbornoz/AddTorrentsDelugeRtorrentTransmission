...
call roarie_commands#AddMapping("&Project", "dap_frame_up", "&Frame up in debugger", "Navigate one frame up in debugger", "<silent>", '<M-S-PageUp>', ':<C-U>require("dap").up()<CR>', "", "")
call roarie_commands#AddMapping("&Project", "dap_frame_down", "&Frame down in debugger", "Navigate one frame down in debugger", "<silent>", '<M-S-PageDown>', ':<C-U>require("dap").down()<CR>', "", "")
