...
call roarie_commands#AddSubMenuItem("build_submenu", "build_clean", " ", "Build c&lean...", ":BuildMe clean")
...
if has('nvim')
call roarie_commands#AddMapping("&Project", "dap_start", "Start/continue &debugging...", "Start/continue debugging session", "<silent>", '<M-F5>', ':<C-U>lua require("dap").roarie.continue()<CR>', "<fnalias>", "")
...
call roarie_commands#AddSubMenuItem("dap_submenu", "dap_frame_focus", " ", "&Jump/focus the current frame", ':lua require("dap").focus_frame()')
call roarie_commands#AddSubMenuItem("dap_submenu", "", " ", "--", "")
...
call roarie_commands#AddSubMenuItem("dap_submenu", "dap_pause", " ", "&Pause thread", ':lua require("dap").pause()')
